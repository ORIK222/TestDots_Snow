  ...
  public struct Range {
    ...
    public long length;
        ...
        */
        ...
        public static Range GetJsonChunk(Stream stream, Encoding encoding)
        {
            stream.Position = 0;
        ...
        /// Throws GlbError on parse errors.
        public static string GetJsonChunkAsString(Stream stream, Encoding encoding)
        {
            Range range = GetJsonChunk(stream, encoding);
        ...
        /// Throws GlbError on parse errors.
        public static Range GetBinChunk(Stream stream, Encoding encoding)
        {
            stream.Position = 0;
            using (BinaryReader reader = new BinaryReader(stream, encoding, true)) {
                if (reader.ReadUInt32() != kFourCC_glTF)
        ...
        /// <summary>
        /// Gets the GLB version.
        /// </summary>
        /// <param name="stream">The stream.</param>
        /// <param name="encoding">The encoding.</param>
        /// <returns></returns>
        public static uint? GetGlbVersion(Stream stream, Encoding encoding)
        {
            stream.Position = 0;
            using (BinaryReader reader = new BinaryReader(stream, encoding, true))
            {
